...
// ==========================================
// 1. Базовый класс сессии SessionBase
// ==========================================
class SessionBase {
protected:
...
template <typename Body, typename Fields>
    void Write(http::response<Body, Fields>&& response) {
        ...
        // Добавляем mutable и очистку указателя
        http::async_write(
            stream_,
            *safe_response,
            [self, safe_response, close](beast::error_code ec, std::size_t bytes_written) mutable {
                safe_response.reset(); // Освобождаем буфер до перехода к чтению следующего пакета!
...
// ==========================================
// 2. Шаблонный класс сессии Session
// ==========================================
...
// ==========================================
// 3. Шаблонный класс приемника Listener
// ==========================================
template <typename RequestHandler>
...
// ==========================================
// 4. Вспомогательная функция запуска ServeHttp
// ==========================================
template <typename RequestHandler>
