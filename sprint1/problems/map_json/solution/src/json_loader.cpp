        ...
        for (const auto& map_value : maps_array) {
            ...
            if (map_obj.contains("buildings")) {
                ...
                for (const auto& build_value : builds_array) {
                    ...
                    // Rоординаты верхнего левого угла здания
                    ...
                    model::Building building(
                        model::Rectangle{
                            model::Point{model::Coord{x}, model::Coord{y}}, // Зависит от того, принимает ли model::Point/Coord явное приведение
                            model::Size{w, h}
                        }
                    );
            ...
            // 4. Добавляем полностью собранную карту в игру
