...
//перевод Direction в строковый формат
std::string_view DirectionToString(model::Direction dir) {
    using namespace std::literals;
    switch (dir) {
        case model::Direction::NORTH: return "N"sv;
        case model::Direction::SOUTH: return "S"sv;
        case model::Direction::WEST:  return "W"sv;
        case model::Direction::EAST:  return "E"sv;
    }
    return "N"sv;
}
